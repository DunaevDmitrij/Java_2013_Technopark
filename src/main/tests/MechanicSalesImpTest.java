...
public class MechanicSalesImpTest {
    ...
    public void buyTest() throws InterruptedException {
        ...
        SingleTicket singleTicket = new SingleTicket("Тапоа", "Пашковский",new Date(1384584530),50400, "931", Ticket.seatClass.SEAT_CLASS_ECONOMIC,"Boing 747-400",1);
        singleTickets.add(singleTicket);
        singleTicket = new SingleTicket("Пашковский", "Bangkok",new Date(1386676800),43200,"932", Ticket.seatClass.SEAT_CLASS_ECONOMIC,"Boing 737-800",2);
        singleTickets.add(singleTicket);
